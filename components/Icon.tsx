...
export const DebugIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 8l-4 4m0 0l-4 4m4-4l4 4m-4-4L8 8" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 3l1.25 1.25M21 21l-1.25-1.25M3 21l1.25-1.25M21 3l-1.25 1.25M12 2v2M12 20v2M2 12h2M20 12h2" />
...
export const FeatureIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L11 15l-4 1 1-4 6.707-6.707a1 1 0 011.414 0z" />
  </svg>
);
...
// Debugger Icons
export const ContinueIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const StepOverIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
