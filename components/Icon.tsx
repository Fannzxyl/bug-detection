...
export const BugIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 2c2.761 0 5 2.239 5 5v2.586l1.707 1.707C19.683 11.663 20 12.314 20 13v3c0 .686-.317 1.337-.879 1.707L17.414 19H6.586l-1.707-1.293C4.317 17.337 4 16.686 4 16v-3c0-.686.317-1.337.879-1.707L6.586 9.586V7c0-2.761 2.239-5 5-5zm-5 7h10M9 20h6m-8-8l-2 2m12-2l2 2m-8-5V7" />
  </svg>
);
